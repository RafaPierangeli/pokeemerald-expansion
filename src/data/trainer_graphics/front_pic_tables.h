const struct MonCoords gTrainerFrontPicCoords[] =
{
    ...
    [TRAINER_PIC_KRYS] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_PROFOAK] = {.size = 8, .y_offset = 1},    
    [TRAINER_PIC_PROFBIRCH] = {.size = 8, .y_offset = 1},
...
const struct CompressedSpriteSheet gTrainerFrontPicTable[] =
{
    ...
    TRAINER_SPRITE(KRYS, gTrainerFrontPic_Krys, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(PROFOAK, gTrainerFrontPic_ProfOak, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(PROFBIRCH, gTrainerFrontPic_ProfBirch, TRAINER_PIC_SIZE),
...
const struct CompressedSpritePalette gTrainerFrontPicPaletteTable[] =
{
    ...
    TRAINER_PAL(KRYS, gTrainerPalette_Krys),
    TRAINER_PAL(PROFOAK, gTrainerPalette_ProfOak),
    TRAINER_PAL(PROFBIRCH, gTrainerPalette_ProfBirch),
