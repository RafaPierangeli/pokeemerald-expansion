...
//Lyra
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_Lyra             = {TAG_NONE, OBJ_EVENT_PAL_LYRA,  OBJ_EVENT_PAL_TAG_BRIDGE_REFLECTION, 512, 16, 32, 0, SHADOW_SIZE_M, FALSE, FALSE, TRACKS_FOOT,      &gObjectEventBaseOam_16x32, sOamTables_16x32, sAnimTable_WalkRun_Asymmetric,    sPicTable_Lyra,           gDummySpriteAffineAnimTable};
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_LyraMachBike     = {TAG_NONE, OBJ_EVENT_PAL_LYRA,  OBJ_EVENT_PAL_TAG_BRIDGE_REFLECTION, 512, 32, 32, 0, SHADOW_SIZE_M, FALSE, FALSE, TRACKS_BIKE_TIRE, &gObjectEventBaseOam_32x32, sOamTables_32x32, sAnimTable_MachBike_Asymmetric,   sPicTable_LyraMachBike,   gDummySpriteAffineAnimTable};
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_LyraAcroBike     = {TAG_NONE, OBJ_EVENT_PAL_LYRA,  OBJ_EVENT_PAL_TAG_BRIDGE_REFLECTION, 512, 32, 32, 0, SHADOW_SIZE_M, FALSE, FALSE, TRACKS_BIKE_TIRE, &gObjectEventBaseOam_32x32, sOamTables_32x32, sAnimTable_AcroBike_Asymmetric,   sPicTable_LyraAcroBike,   gDummySpriteAffineAnimTable};
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_LyraSurfing      = {TAG_NONE, OBJ_EVENT_PAL_LYRA,  OBJ_EVENT_PAL_TAG_NONE,              512, 32, 32, 0, SHADOW_SIZE_M, FALSE, TRUE,  TRACKS_FOOT,      &gObjectEventBaseOam_32x32, sOamTables_32x32, sAnimTable_Surfing_Asymmetric,    sPicTable_LyraSurfing,    gDummySpriteAffineAnimTable};
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_LyraUnderwater   = {TAG_NONE, OBJ_EVENT_PAL_TAG_PLAYER_UNDERWATER,  OBJ_EVENT_PAL_TAG_NONE, 512, 32, 32, 0, SHADOW_SIZE_M, FALSE, TRUE,  TRACKS_FOOT,  &gObjectEventBaseOam_32x32, sOamTables_32x32, sAnimTable_Underwater_Asymmetric, sPicTable_LyraUnderwater, gDummySpriteAffineAnimTable};
...
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_LyraFishing      = {TAG_NONE, OBJ_EVENT_PAL_LYRA,  OBJ_EVENT_PAL_TAG_BRIDGE_REFLECTION, 512, 32, 32, 0, SHADOW_SIZE_M, FALSE, FALSE, TRACKS_FOOT,      &gObjectEventBaseOam_32x32, sOamTables_32x32, sAnimTable_Fishing_Asymmetric,    sPicTable_LyraFishing,    gDummySpriteAffineAnimTable};
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_LyraWatering     = {TAG_NONE, OBJ_EVENT_PAL_LYRA,  OBJ_EVENT_PAL_TAG_BRIDGE_REFLECTION, 512, 32, 32, 0, SHADOW_SIZE_M, FALSE, FALSE, TRACKS_FOOT,      &gObjectEventBaseOam_32x32, sOamTables_32x32, sAnimTable_Watering_Asymmetric,   sPicTable_LyraWatering,   gDummySpriteAffineAnimTable};
...
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_StevenUnderwater  = {TAG_NONE, OBJ_EVENT_PAL_TAG_PLAYER_UNDERWATER,  OBJ_EVENT_PAL_TAG_NONE,              512, 32, 32, 0, SHADOW_SIZE_M, FALSE, TRUE,  TRACKS_FOOT,      &gObjectEventBaseOam_32x32, sOamTables_32x32, sAnimTable_Standard,   sPicTable_StevenUnderwater, gDummySpriteAffineAnimTable};
...
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_WallyUnderwater   = {TAG_NONE, OBJ_EVENT_PAL_TAG_PLAYER_UNDERWATER,  OBJ_EVENT_PAL_TAG_NONE,              512, 32, 32, 0, SHADOW_SIZE_M, FALSE, TRUE,  TRACKS_FOOT,      &gObjectEventBaseOam_32x32, sOamTables_32x32, sAnimTable_Standard,   sPicTable_WallyUnderwater, gDummySpriteAffineAnimTable};
