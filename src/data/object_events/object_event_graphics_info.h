...
//Lyra
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_Lyra             = {TAG_NONE, OBJ_EVENT_PAL_LYRA,  OBJ_EVENT_PAL_TAG_BRIDGE_REFLECTION, 512, 16, 32, 0, SHADOW_SIZE_M, FALSE, FALSE, TRACKS_FOOT,      &gObjectEventBaseOam_16x32, sOamTables_16x32, sAnimTable_Standard_Asymmetric,    sPicTable_Lyra,           gDummySpriteAffineAnimTable};
