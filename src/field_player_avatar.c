...
static const u16 sPlayerAvatarGfxIds[][PLAYER_STYLE_COUNT] =
{
    ...
    [PLAYER_AVATAR_STATE_NORMAL]     = {OBJ_EVENT_GFX_BRENDAN_NORMAL,     OBJ_EVENT_GFX_MAY_NORMAL,      OBJ_EVENT_GFX_RED,             OBJ_EVENT_GFX_LEAF,            OBJ_EVENT_GFX_ETHAN,            OBJ_EVENT_GFX_LYRA,            OBJ_EVENT_GFX_LUCAS,            OBJ_EVENT_GFX_DAWN,            OBJ_EVENT_GFX_KRIS,            OBJ_EVENT_GFX_STEVEN},
    [PLAYER_AVATAR_STATE_MACH_BIKE]  = {OBJ_EVENT_GFX_BRENDAN_MACH_BIKE,  OBJ_EVENT_GFX_MAY_MACH_BIKE,   OBJ_EVENT_GFX_RED_MACH_BIKE,   OBJ_EVENT_GFX_LEAF_MACH_BIKE,  OBJ_EVENT_GFX_ETHAN_MACH_BIKE,  OBJ_EVENT_GFX_LYRA_MACH_BIKE,  OBJ_EVENT_GFX_LUCAS_MACH_BIKE,  OBJ_EVENT_GFX_DAWN_MACH_BIKE,  OBJ_EVENT_GFX_KRIS_MACH_BIKE,  OBJ_EVENT_GFX_STEVEN_MACH_BIKE},
    [PLAYER_AVATAR_STATE_ACRO_BIKE]  = {OBJ_EVENT_GFX_BRENDAN_ACRO_BIKE,  OBJ_EVENT_GFX_MAY_ACRO_BIKE,   OBJ_EVENT_GFX_RED_ACRO_BIKE,   OBJ_EVENT_GFX_LEAF_ACRO_BIKE,  OBJ_EVENT_GFX_ETHAN_ACRO_BIKE,  OBJ_EVENT_GFX_LYRA_ACRO_BIKE,  OBJ_EVENT_GFX_LUCAS_ACRO_BIKE,  OBJ_EVENT_GFX_DAWN_ACRO_BIKE,  OBJ_EVENT_GFX_KRIS_ACRO_BIKE,  OBJ_EVENT_GFX_STEVEN_ACRO_BIKE},
    [PLAYER_AVATAR_STATE_SURFING]    = {OBJ_EVENT_GFX_BRENDAN_SURFING,    OBJ_EVENT_GFX_MAY_SURFING,     OBJ_EVENT_GFX_RED_SURFING,     OBJ_EVENT_GFX_LEAF_SURFING,    OBJ_EVENT_GFX_ETHAN_SURFING,    OBJ_EVENT_GFX_LYRA_SURFING,    OBJ_EVENT_GFX_LUCAS_SURFING,    OBJ_EVENT_GFX_DAWN_SURFING,    OBJ_EVENT_GFX_KRIS_SURFING,    OBJ_EVENT_GFX_STEVEN_SURFING},
    [PLAYER_AVATAR_STATE_UNDERWATER] = {OBJ_EVENT_GFX_BRENDAN_SURFING,    OBJ_EVENT_GFX_MAY_UNDERWATER,  OBJ_EVENT_GFX_RED_SURFING,     OBJ_EVENT_GFX_LEAF_SURFING,    OBJ_EVENT_GFX_ETHAN_SURFING,    OBJ_EVENT_GFX_LYRA_SURFING,    OBJ_EVENT_GFX_LUCAS_SURFING,    OBJ_EVENT_GFX_DAWN_SURFING,    OBJ_EVENT_GFX_KRIS_SURFING,    OBJ_EVENT_GFX_STEVEN_SURFING},
    [PLAYER_AVATAR_STATE_FIELD_MOVE] = {OBJ_EVENT_GFX_BRENDAN_FIELD_MOVE, OBJ_EVENT_GFX_MAY_FIELD_MOVE,  OBJ_EVENT_GFX_RED_FIELD_MOVE,  OBJ_EVENT_GFX_LEAF_FIELD_MOVE, OBJ_EVENT_GFX_ETHAN_FIELD_MOVE, OBJ_EVENT_GFX_LYRA_FIELD_MOVE, OBJ_EVENT_GFX_LUCAS_FIELD_MOVE, OBJ_EVENT_GFX_DAWN_FIELD_MOVE, OBJ_EVENT_GFX_KRIS_FIELD_MOVE, OBJ_EVENT_GFX_STEVEN_FIELD_MOVE},
    [PLAYER_AVATAR_STATE_FISHING]    = {OBJ_EVENT_GFX_BRENDAN_FISHING,    OBJ_EVENT_GFX_MAY_FISHING,     OBJ_EVENT_GFX_RED_FISHING,     OBJ_EVENT_GFX_LEAF_FISHING,    OBJ_EVENT_GFX_ETHAN_FISHING,    OBJ_EVENT_GFX_LYRA_FISHING,    OBJ_EVENT_GFX_LUCAS_FISHING,    OBJ_EVENT_GFX_DAWN_FISHING,    OBJ_EVENT_GFX_KRIS_FISHING,    OBJ_EVENT_GFX_STEVEN_FISHING},
    [PLAYER_AVATAR_STATE_WATERING]   = {OBJ_EVENT_GFX_BRENDAN_WATERING,   OBJ_EVENT_GFX_MAY_WATERING,    OBJ_EVENT_GFX_RED_WATERING,    OBJ_EVENT_GFX_LEAF_WATERING,   OBJ_EVENT_GFX_ETHAN_WATERING,   OBJ_EVENT_GFX_LYRA_WATERING,   OBJ_EVENT_GFX_LUCAS_WATERING,   OBJ_EVENT_GFX_DAWN_WATERING,   OBJ_EVENT_GFX_KRIS_WATERING,   OBJ_EVENT_GFX_STEVEN_WATERING}
...
static const u16 sPlayerAvatarGfxToStateFlag[PLAYER_STYLE_COUNT][5][2] =
{
    [STYLE_BRENDAN] =
    {
        ...
        {OBJ_EVENT_GFX_BRENDAN_ACRO_BIKE, PLAYER_AVATAR_FLAG_ACRO_BIKE}, //acro
        {OBJ_EVENT_GFX_BRENDAN_SURFING,   PLAYER_AVATAR_FLAG_SURFING},
        {OBJ_EVENT_GFX_BRENDAN_SURFING,   PLAYER_AVATAR_FLAG_UNDERWATER}, //underwater
    },
    ...
    [STYLE_MAY] =
    {
        ...
        {OBJ_EVENT_GFX_MAY_ACRO_BIKE, PLAYER_AVATAR_FLAG_ACRO_BIKE}, //acro
        {OBJ_EVENT_GFX_MAY_SURFING,   PLAYER_AVATAR_FLAG_SURFING},
        {OBJ_EVENT_GFX_MAY_SURFING,   PLAYER_AVATAR_FLAG_UNDERWATER}, //underwater
    },
    ...
    [STYLE_RED] =
    {
        ...
        {OBJ_EVENT_GFX_RED_ACRO_BIKE, PLAYER_AVATAR_FLAG_ACRO_BIKE}, //acro
        {OBJ_EVENT_GFX_RED_SURFING,   PLAYER_AVATAR_FLAG_SURFING},
        {OBJ_EVENT_GFX_RED_SURFING,   PLAYER_AVATAR_FLAG_UNDERWATER}, //underwater
    },
    ...
    [STYLE_LEAF] =
    {
        ...
        {OBJ_EVENT_GFX_LEAF_ACRO_BIKE, PLAYER_AVATAR_FLAG_ACRO_BIKE}, //acro
        {OBJ_EVENT_GFX_LEAF_SURFING,   PLAYER_AVATAR_FLAG_SURFING},
        {OBJ_EVENT_GFX_LEAF_SURFING,   PLAYER_AVATAR_FLAG_UNDERWATER}, //underwater
    },
    ...
    [STYLE_ETHAN] =
    {
        ...
        {OBJ_EVENT_GFX_ETHAN_ACRO_BIKE, PLAYER_AVATAR_FLAG_ACRO_BIKE}, //acro
        {OBJ_EVENT_GFX_ETHAN_SURFING,   PLAYER_AVATAR_FLAG_SURFING},
        {OBJ_EVENT_GFX_ETHAN_SURFING,   PLAYER_AVATAR_FLAG_UNDERWATER}, //underwater
    },
    ...
    [STYLE_LYRA] =
    {
        ...
        {OBJ_EVENT_GFX_LYRA_ACRO_BIKE, PLAYER_AVATAR_FLAG_ACRO_BIKE}, //acro
        {OBJ_EVENT_GFX_LYRA_SURFING,   PLAYER_AVATAR_FLAG_SURFING},
        {OBJ_EVENT_GFX_LYRA_SURFING,   PLAYER_AVATAR_FLAG_UNDERWATER}, //underwater
    },
    ...
    [STYLE_LUCAS] =
    {
        ...
        {OBJ_EVENT_GFX_LUCAS_ACRO_BIKE, PLAYER_AVATAR_FLAG_ACRO_BIKE}, //acro
        {OBJ_EVENT_GFX_LUCAS_SURFING,   PLAYER_AVATAR_FLAG_SURFING},
        {OBJ_EVENT_GFX_LUCAS_SURFING,   PLAYER_AVATAR_FLAG_UNDERWATER}, //underwater
    },
    ...
    [STYLE_DAWN] =
    {
        ...
        {OBJ_EVENT_GFX_DAWN_ACRO_BIKE, PLAYER_AVATAR_FLAG_ACRO_BIKE}, //acro
        {OBJ_EVENT_GFX_DAWN_SURFING,   PLAYER_AVATAR_FLAG_SURFING},
        {OBJ_EVENT_GFX_DAWN_SURFING,   PLAYER_AVATAR_FLAG_UNDERWATER}, //underwater
    },
        [STYLE_KRIS] =
    {
        {OBJ_EVENT_GFX_KRIS,           PLAYER_AVATAR_FLAG_ON_FOOT},
        {OBJ_EVENT_GFX_KRIS_MACH_BIKE, PLAYER_AVATAR_FLAG_MACH_BIKE},
        {OBJ_EVENT_GFX_KRIS_ACRO_BIKE, PLAYER_AVATAR_FLAG_ACRO_BIKE}, //acro
        {OBJ_EVENT_GFX_KRIS_SURFING,   PLAYER_AVATAR_FLAG_SURFING},
        {OBJ_EVENT_GFX_KRIS_SURFING,   PLAYER_AVATAR_FLAG_UNDERWATER}, //underwater
    },
        [STYLE_STEVEN] =
    {
        {OBJ_EVENT_GFX_STEVEN,           PLAYER_AVATAR_FLAG_ON_FOOT},
        {OBJ_EVENT_GFX_STEVEN_MACH_BIKE, PLAYER_AVATAR_FLAG_MACH_BIKE},
        {OBJ_EVENT_GFX_STEVEN_ACRO_BIKE, PLAYER_AVATAR_FLAG_ACRO_BIKE}, //acro
        {OBJ_EVENT_GFX_STEVEN_SURFING,   PLAYER_AVATAR_FLAG_SURFING},
        {OBJ_EVENT_GFX_STEVEN_SURFING,   PLAYER_AVATAR_FLAG_UNDERWATER}, //underwater
    },
};
...
{
    return sPlayerAvatarGfxIds[state][costumeId];
}
...
{
return GetPlayerAvatarGraphicsIdByStateIdAndGender(state, gSaveBlock2Ptr->costume);
}
...
u8 GetPlayerAvatarGenderByGraphicsId(u16 gfxId)
{
    ...
    case OBJ_EVENT_GFX_RED_WATERING:
        return STYLE_RED;
    ...
    case OBJ_EVENT_GFX_ETHAN_WATERING:
        return STYLE_ETHAN;
    ...
    case OBJ_EVENT_GFX_STEVEN_MACH_BIKE:
    case OBJ_EVENT_GFX_STEVEN_ACRO_BIKE:
    case OBJ_EVENT_GFX_STEVEN_SURFING:
    case OBJ_EVENT_GFX_STEVEN_FIELD_MOVE:
    case OBJ_EVENT_GFX_STEVEN_FISHING:
    case OBJ_EVENT_GFX_STEVEN_WATERING:
        return STYLE_STEVEN;
...
static u8 GetPlayerAvatarStateTransitionByGraphicsId(u16 graphicsId, u8 costumeId)
{
    u8 i;

    for (i = 0; i < ARRAY_COUNT(sPlayerAvatarGfxToStateFlag[0]); i++)
    {
        if (sPlayerAvatarGfxToStateFlag[costumeId][i][0] == graphicsId)
            return sPlayerAvatarGfxToStateFlag[costumeId][i][1];
    }
...
u16 GetPlayerAvatarGraphicsIdByCurrentState(void)
{
    ...
    for (i = 0; i < ARRAY_COUNT(sPlayerAvatarGfxToStateFlag[0]); i++)
    {
        if (sPlayerAvatarGfxToStateFlag[costumeId][i][1] & flags)
            return sPlayerAvatarGfxToStateFlag[costumeId][i][0];
    }
    return 0;
}
...
void InitPlayerAvatar(s16 x, s16 y, u8 direction, u8 gender)
{
    ...
    playerObjEventTemplate.graphicsId = GetPlayerAvatarGraphicsIdByStateIdAndGender(PLAYER_AVATAR_STATE_NORMAL, gSaveBlock2Ptr->costume);
    ...
    gPlayerAvatar.gender = costumeId;
